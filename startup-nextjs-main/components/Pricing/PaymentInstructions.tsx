      ...
      <div className="h-full border-b-2 border-blue pb-5">
        <div className="-mx-4">
            <div className="mb-8 mt-8 md:mb-0 lg:mb-12 flex justify-around">
                <div className="ml-3">
                    <h1 
                        className="mb-5 text-2xl md:text-3xl font-bold text-blue text-center"
                        style={{fontFamily: "Libre Franklin, Helios Extended, sans-serif"}}
                    >
                        Payment Instructions
                    </h1>
                    <p 
                        className="text-base text-md md:text-lg font-medium leading-relaxed text-center text-blue mt-4"
                        style={{fontFamily: "Libre Franklin, Helios Extended, sans-serif"}}
                    >
