...
const DelegationReceiptPage = () => {
    ...
    e.preventDefault();
    const id = localStorage.getItem('delegation_id');
            ...
            <div className="w-full px-4">
              <div className="shadow-three mx-auto max-w-[700px] rounded bg-white px-6 py-10 sm:p-[60px]">
                ...
                <p className="mb-11 text-center text-base font-medium text-body-col">
                  Kindly upload a combined PDF of all the payment receipts from WHISH.
                  You can combine the receipts into one PDF{" "}
                  <Link
...
export default DelegationReceiptPage;