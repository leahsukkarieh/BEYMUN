...
const RegisterCommitteesHSDelegatePage = () => {
              ...
              <div className="shadow-three mx-auto max-w-[700px] rounded bg-white px-6 py-10 sm:p-[60px]">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-8">
                        ...
                        <select
                          name="first_choice" // Added name attribute
                          value={formData.first_choice}
                          onChange={handleChange}
                          defaultValue=""
                        >
                          <option style={{ fontSize: '16px', padding: '8px 12px' }} value="" disabled>Select First Choice</option>
                    ...
                    <div className="mb-8">
                        ...
                        <select
                          ...
                          defaultValue=""
                        >
                          <option style={{ fontSize: '16px', padding: '8px 12px' }} value="" disabled>Select Second Choice</option>
                          {hsCommitteeData.map((committee, index) => (
...
export default RegisterCommitteesHSDelegatePage;
